# Épico 4 — Navegação e Conteúdo Institucional

História que disponibiliza as seções institucionais do site por meio de um menu lateral, acessível a professor e administrador.

---

## US18 — Navegação com seções institucionais `MUST` · 3 pts

**Como** professor ou administrador, **posso** acessar as seções institucionais do site por meio de um menu de navegação, **para que** eu encontre as informações de apoio e conteúdo da editora sem sair da plataforma.
